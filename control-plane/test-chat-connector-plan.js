...
async function testChatConnectorPlanImplementation() {
  ...
  try {
    ...
    if (planValidation.canCreateChatConnector) {
  ...
  try {
    ...
    if (subscriptionCleanupService.start && subscriptionCleanupService.stop) {
