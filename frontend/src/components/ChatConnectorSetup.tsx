...
function ChatConnectorSetup({ sourceId, sourceName }) {
  ...
  const handleConnectPlatform = async (platform) => {
    if (!canCreateConnector) {
      alert(
        `You've reached your chat connector limit (${currentConnectors}/${maxConnectors}). Please upgrade your plan to add more chat connectors.`,
      );
      return;
    }
            ...
            <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              {!canCreateConnector && (
                <div className="mt-2 text-xs text-blue-600">
                  You've reached your chat connector limit.{" "}
                  <a
