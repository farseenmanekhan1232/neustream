  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with the Neustream team for support, questions, or feedback about our multistreaming platform."
        />
        <meta
          name="keywords"
          content="contact neustream, support, help, customer service, streaming support"
        />
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Have questions about Neustream? Need help with your streams? We're
            here to help. Reach out through any of the channels below or send us
            a message.
          </p>
        </div>
