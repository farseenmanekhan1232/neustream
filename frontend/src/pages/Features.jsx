  ...
  const featuredSimulators = [
    {
      ...
      description:
        "Stream to YouTube, Twitch, Facebook, TikTok, and LinkedIn simultaneously from a single source.",
      details: [
    ...
    },
    {
      ...
      description:
        "Aggregate and manage chat from all streaming platforms in one intuitive interface.",
      details: [
    ...
    },
    {
      ...
      description:
        "Eliminate hardware bottlenecks with cloud-based encoding and intelligent resource management.",
      details: [
  ...
  const additionalFeatures = [
    {
      ...
      description:
        "Protect your streams and credentials with military-grade encryption and security protocols.",
      details: [
    ...
    },
    {
      ...
      description:
        "Works seamlessly with all major streaming software and hardware configurations.",
      details: [
    ...
    },
    {
      ...
      description:
        "Gain deep insights into your stream performance and audience engagement across all platforms.",
      details: [
    ...
    },
    {
      ...
      description:
        "Fine-tune every aspect of your streaming setup with comprehensive configuration options.",
      details: [
        ...
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg opacity-80">
              Everything you need to stream professionally, from security to
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {additionalFeatures.map((feature, index) => (
              <div
                key={feature.title}
                className="bg-white/5 rounded-2xl p-8 space-y-4 hover:bg-white/10 transition-all duration-300"
              >
                <div className="flex items-center space-x-4">
                  <div className="p-3 bg-white/10 rounded-xl">
                    <feature.icon className="h-6 w-6 text-white" />
                ...
                <ul className="space-y-2">
                  {feature.details.map((detail, detailIndex) => (
                    <li
                      key={detailIndex}
                      className="flex items-start space-x-3 text-sm opacity-80"
                    >
        ...
        <div className="container-custom">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/5 rounded-2xl p-6">
              <Marquee
                items={platformIcons.map((platform) => (
                  <div
                    key={platform.name}
                    className="flex flex-col items-center space-y-2"
                  >
                    <div
                      className={`${platform.color} p-4 rounded-xl bg-white/5`}
                    >
                      {platform.icon}
                    </div>
