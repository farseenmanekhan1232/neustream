  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="Neustream's privacy policy - How we collect, use, and protect your information"
        />
        <meta
          name="keywords"
          content="privacy policy, data protection, user privacy, neustream"
        />
          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  when you create an account, use our streaming services, or
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Authentication credentials (handled securely through OAuth
                    providers)
                  </li>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Streaming platforms and services you connect to your account
                  </li>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  Security measures include encryption, secure authentication
                  protocols, regular security audits, and employee training on
