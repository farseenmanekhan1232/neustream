...
const StreamingDemo = () => {
  ...
  const handleStreamToggle = () => {
    ...
    if (!isStreaming) {
      setStreamStats({ viewers: 0, duration: "00:00:00", bitrate: "0 kbps", fps: 0 });
    }
  };
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Try out the NeuStream interface without going live. This is a fully functional demo that simulates the real streaming experience.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="stream-config" className="w-full">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Use these details in your broadcasting software (OBS, Streamlabs, etc.)
                    </CardDescription>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      {isStreaming ? "Your stream is live!" : "Start streaming to see real-time stats"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-3 bg-muted rounded-lg">
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <span className="text-2xl font-bold">{streamStats.viewers}</span>
                        </div>
                      ...
                      <div className="text-center p-3 bg-muted rounded-lg">
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <span className="text-2xl font-bold">{streamStats.bitrate}</span>
                        </div>
                        <p className="text-xs text-muted-foreground">Bitrate</p>
                      </div>
                      <div className="text-center p-3 bg-muted rounded-lg">
                        <span className="text-2xl font-bold">{streamStats.fps}</span>
                        <p className="text-xs text-muted-foreground">FPS</p>
                      </div>
                      <div className="text-center p-3 bg-muted rounded-lg">
                        <span className="text-lg font-bold">{streamStats.duration}</span>
              ...
              <Card className="bg-blue-50 border-blue-200">
                <CardContent className="pt-6">
                  ...
                  <ol className="space-y-1 text-sm text-blue-800">
                    <li>1. Add streaming destinations in the "Destinations" tab</li>
                    <li>2. Click "Start Streaming" to simulate a live stream</li>
                    <li>3. Watch the stats update in real-time</li>
                    <li>4. Try adding/removing destinations while streaming</li>
                    <li>5. Explore the chat connectors tab for integration options</li>
                  </ol>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="destinations" className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-semibold">Streaming Destinations</h3>
                ...
                <Card className="border-dashed">
                  <CardContent className="pt-6">
                    <div className="text-center space-y-4">
                      ...
                      <div>
                        <h4 className="text-lg font-medium">No destinations yet</h4>
                        <p className="text-sm text-muted-foreground">
                          Add your first streaming destination to start multi-platform broadcasting
                        </p>
                      </div>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            ...
                            <span>{Math.floor(Math.random() * 100)} viewers</span>
                          </div>
            ...
            <TabsContent value="chat" className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Connect your chat from different platforms to interact with your audience
                </p>
                    ...
                    <Card className="border-dashed md:col-span-2">
                      <CardContent className="pt-6">
                        <div className="text-center space-y-4">
                          ...
                          <div>
                            <h4 className="text-lg font-medium">No platforms connected</h4>
                            <p className="text-sm text-muted-foreground">
                              Add streaming destinations first to connect their chats
                            </p>
                          </div>
                        </div>
                      </CardContent>
