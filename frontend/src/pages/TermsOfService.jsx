  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Neustream's terms of service - Rules and guidelines for using our streaming platform" />
        <meta name="keywords" content="terms of service, terms and conditions, legal agreement, neustream" />
        <meta property="og:title" content="Terms of Service - Neustream" />
        <meta property="og:description" content="Neustream's terms of service - Rules and guidelines for using our streaming platform" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Terms of Service - Neustream" />
        <meta name="twitter:description" content="Neustream's terms of service - Rules and guidelines for using our streaming platform" />
      </Helmet>
          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  By accessing and using Neustream ("the Service"), you accept and agree to be bound
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Neustream is a multistreaming platform that allows users to broadcast live video
                  content simultaneously to multiple streaming platforms. The service includes:
                </p>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <h3 className="text-lg font-medium text-foreground">Streaming Guidelines</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li>Respect community guidelines of all connected platforms</li>
                  <li>Do not stream copyrighted content without permission</li>
                  <li>Maintain appropriate content for your intended audience</li>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  You retain ownership of all content you create and stream through our service. By
                  using our service, you grant us a limited, non-exclusive license to use, reproduce,
                  and distribute your content solely for the purpose of providing our service.
                </p>

                <h3 className="text-lg font-medium text-foreground">Our Content</h3>
                <p>
                  The Neustream service, including its software, design, and content, is protected
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <h3 className="text-lg font-medium text-foreground">Termination by You</h3>
                <p>
                  You may terminate your account at any time through your account settings or by
                  contacting our support team.
                </p>

                <h3 className="text-lg font-medium text-foreground">Termination by Us</h3>
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  To the maximum extent permitted by law, Neustream shall not be liable for any
                  indirect, incidental, special, or consequential damages arising from your use of
                  our service.
                </p>
                <p>
                  Our total liability for any claims relating to the service shall not exceed the
                  amount you paid for the service in the six months preceding the claim.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  the jurisdiction where Neustream operates, without regard to its conflict of law
                  provisions.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  upon posting to our website. Your continued use of the service constitutes acceptance
                  of any modified terms.
                </p>
                <p>
                  For material changes, we will provide reasonable notice, such as email notification
                  or prominent website announcement.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <ul className="list-none space-y-2">
                  <li>Email: legal@neustream.app</li>
