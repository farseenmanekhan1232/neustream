            ...
            {[
              {
                ...
                description: "Our servers handle the heavy computational load of multi-streaming, reducing CPU usage on your machine by up to 60%."
              },
              {
                icon: (
                  <svg className="h-10 w-10 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Maintain high frame rates in your games or creative applications while streaming to multiple platforms simultaneously."
              },
              {
                icon: (
                  <svg className="h-10 w-10 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Run resource-intensive applications alongside your streams without compromising quality or performance."
              },
              {
                icon: (
                  <svg className="h-10 w-10 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Track viewer engagement, growth metrics, and performance statistics across all platforms in one place."
              },
              {
                icon: (
                  <svg className="h-10 w-10 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Our distributed infrastructure ensures your streams stay live even if individual servers experience issues."
              },
              {
                icon: (
                  <svg className="h-10 w-10 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: "Deliver high-quality streams to viewers worldwide with minimal latency through our optimized content delivery network."
              }
            ].map((feature, index) => (
        ...
        <div className="container-custom">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Join thousands of content creators who have already upgraded their streaming setup with NeuStream.
            </p>
            <Link
              to="/auth"
